...
<?php
/*
Template Name: Collaborators List (U5)
*/
?>
...
<?php
if(get_field('repeater_collaborator_groups')) :
while( has_sub_field('repeater_collaborator_groups')) :?>

<div class="people-grid members">
	<h3><?php the_sub_field('collaborator_group_heading'); ?></h3>
	
	<?php $members = get_sub_field('relationship_collaborators');
	if($members):
